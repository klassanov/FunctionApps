...
using FunctionApp.Queue.RestAPI.TableStorage;
...
namespace FunctionApp.Queue.RestAPI
{
    ...
    {
        /// <summary>
        /// We have 2 output bindings: a table and a queue, both pointing to the local storage account emulator
        /// </summary>
        /// <param name="req"></param>
        /// <param name="todoTableCollector"></param>
        ...
        public static async Task<IActionResult> CreateTodo(
            ...
            [Table(tableName: "todos", Connection = "AzureWebJobsStorage")] IAsyncCollector<ToDoTableEntity> todoTableCollector,
            [Queue(queueName: "todos", Connection = "AzureWebJobsStorage")] IAsyncCollector<Todo> todoQueue,
            ILogger logger)
        {
            ...
            await todoTableCollector.AddAsync(todo.ToTableEntity());
